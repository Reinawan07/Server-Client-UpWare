        ...
        <>
            <div className="navbar bg-base-100 border-b shadow-xl mb-5 sticky top-0 z-50">
                <div className="navbar-start">
                    <Link href="/" className="hover:text-primary font-bold focus:outline-none focus:shadow-outline transition duration-300 text-2xl ml-4"><b className="text-primary">Up</b><b className="text-accent">Ware</b></Link>
                </div>
